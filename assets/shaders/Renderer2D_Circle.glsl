...
layout(location=3) out vec2 v_local_pos;
...
layout (set = 0, binding = 4) uniform texture2D u_textures[MAX_TEXTURE_SLOTS];
#else
...
void main()
{
    ...
    float holeCut = smoothstep(innerRadius, innerRadius + v_fade, r);
